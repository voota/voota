...
ALTER TABLE `voota`.`enlace` ADD COLUMN `propuesta_id` INT(11) NULL DEFAULT NULL  AFTER `politico_id` , 
  ADD CONSTRAINT `fk_enlace_2`
  FOREIGN KEY (`propuesta_id` )
  REFERENCES `voota`.`propuesta` (`id` )
  ON DELETE NO ACTION
  ON UPDATE NO ACTION
, ADD INDEX `fk_enlace_2` (`propuesta_id` ASC) ;
