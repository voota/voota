...
<li class="review" id="<?php echo "sf_review_c_m".$review->getId() ?>">
  ...
  <div class="review-name">
  	<a title='<?php echo $review->getsfGuardUser()->getProfile() ?>' href="<?php echo url_for('@usuario?username='.$review->getsfGuardUser()->getProfile()->getVanity())?>"><?php echo fullName( $review->getsfGuardUser(), 15 ) ?></a>
    <?php echo __('sobre') ?>
