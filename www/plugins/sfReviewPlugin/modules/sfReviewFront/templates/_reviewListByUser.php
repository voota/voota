...
<script type="text/javascript">
  $(document).ready(function(){
	...
	<form id="filterForm" method="post" action="<?php echo url_for( '@'.sfContext::getInstance()->getRouting()->getCurrentRouteName(). (isset($user)?'?username='.$user->getProfile()->getVanity():'') )?>">
  	  <p>
