...
<script type="text/javascript">
  $(document).ready(function(){
	...
	<form id="filterForm" method="post" action="<?php echo url_for( '@'.sfContext::getInstance()->getRouting()->getCurrentRouteName(). (isset($user) && $sf_request->getParameter('action') == 'show'?'?username='.$user->getProfile()->getVanity():'') )?>#profile_comments_header">
  	  <p>
