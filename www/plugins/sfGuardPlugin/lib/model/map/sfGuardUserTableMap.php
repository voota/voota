...
class sfGuardUserTableMap extends TableMap {
    ...
    $this->addRelation('EtiquetaPolitico', 'EtiquetaPolitico', RelationMap::ONE_TO_MANY, array('id' => 'sf_guard_user_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('EtiquetaPartido', 'EtiquetaPartido', RelationMap::ONE_TO_MANY, array('id' => 'sf_guard_user_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('EtiquetaPropuesta', 'EtiquetaPropuesta', RelationMap::ONE_TO_MANY, array('id' => 'sf_guard_user_id', ), 'RESTRICT', 'RESTRICT');
