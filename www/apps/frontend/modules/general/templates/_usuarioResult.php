...
<tr>
	<td class="photo">
		<?php echo link_to(image_tag(S3Voota::getImagesUrl().'/usuarios/cc_s_'.($obj->getProfile()->getImagen()!=''?$obj->getProfile()->getImagen():'p_unknown.png'), 'alt="'. __('Foto de %1%', array('%1%' => $obj)) .'"'), '@usuario?username='.$obj->getProfile()->getVanity()) ?>
  </td>
  <td class="name">
