<li>
	<div class="avatar">
    	<?php echo image_tag(S3Voota::getImagesUrl().'/partidos/cc_s_'.($partido->getImagen()!=''?$partido->getImagen():'p_unknown.png'), 'width="36" height="36" alt="'. __('Foto de %1%', array('%1%' => $partido)) .'"') ?>
    </div>
