...
<div class="entity-page">
  ...
  <h2 id="name">
    ...
    <span class="rank">
    	...
    	<?php echo format_number_choice('[0] y %1% votos negativos|[1] y 1 voto negativo|(1,+Inf] y %1% votos negativos', array('%1%' => $politico->getSumd()), $politico->getSumd()) ?>
    </span>
  </h2>
  ...
  <div id="content">
    ...
    <div title="info" id="description">
      ...
      <div title="biografia" class="bio">
        ...
        <?php foreach ( $politico->getPoliticoListas() as $politicoLista): ?>
