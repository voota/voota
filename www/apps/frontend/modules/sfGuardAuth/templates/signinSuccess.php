    ...
    <div class="formSing">
      <?php echo form_tag('@sf_guard_signin') ?>
        ...
        <table id="signin">
          ...
          <tr>
            <td class="leftSing"><h5><?php echo __('Apellidos') ?></h5></td>
            <td class="campo">
          ...
          <tr>
            <td class="leftSing"><h5><?php echo __('Contraseña') ?></h5></td>
            <td class="campo">
          ...
          <tr>
            ...
            <td class="legal">
              He leído y acepto el <?php echo link_to(__('aviso legal'), __('http://blog.voota.es/es/aviso-legal'), array()) ?><?php echo $registrationform['accept']->render() ?>
...
<div id="contentRightSing">
  <div title="ficha">
    <span class="tituloAzul"><?php echo __('¿Ya estás registrado? Adelante :)')?></span>
    <div class="formSing">
      <form action="<?php echo url_for('@sf_guard_signin') ?>" method="post">
        <table id="login">
          ...
          <tr>
            <td class="leftSing"><h5><?php echo __('Recordar') ?></h5></td>
            <td>
          ...
          <tr>
            <td>&nbsp;</td>
            <td><h6><?php echo link_to(__('¿Olvidaste tu contraseña?'), 'sfGuardAuth/reminder') ?></h6></td>
          </tr>
          <tr>
            <td class="leftSing">&nbsp;</td>
            <td class="boton"><input name="button" type="submit" class="button" value="Entrar"></td>
          </tr>
        </table>
      </form>
    </div>
