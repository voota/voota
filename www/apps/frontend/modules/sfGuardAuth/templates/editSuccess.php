        ...
        <table id="editProfile">   
          <tr>
            <td class="anchoColumna tituloCampo tdperfil">
              <?php if ($profileEditForm['nombre']->hasError()): ?>
          ...
          <tr>
            <td class="anchoColumna tituloCampo tdperfil">
              <?php if ($profileEditForm['apellidos']->hasError()): ?>
                <ul class="error_list"><li>&nbsp;</li></ul>
              <?php endif ?>
          ...
          <tr>
            <td class="anchoColumna tituloCampo tdperfil">
              <?php if ($profileEditForm['presentacion']->hasError()): ?>
                <ul class="error_list"><li>&nbsp;</li></ul>
              <?php endif ?>
          ...
          <tr>
            <td class="anchoColumna tituloCampo tdperfil">
              <?php if ($profileEditForm['fecha_nacimiento']->hasError()): ?>
                <ul class="error_list"><li>&nbsp;</li></ul>
              <?php endif ?>
          ...
          <tr>
            <td class="anchoColumna tituloCampo tdperfil">
              <?php if ($profileEditForm['vanity']->hasError()): ?>
                <ul class="error_list"><li>&nbsp;</li></ul>
              <?php endif ?>
          ...
          <tr>
            <td class="anchoColumna tituloCampo tdperfil">
              <?php if ($profileEditForm['imagen']->hasError()): ?>
                <ul class="error_list"><li>&nbsp;</li></ul>
              <?php endif ?>
          ...
          <tr>
            <td class="anchoColumna tituloCampo tdperfil">
              <?php if ($profileEditForm['username']->hasError()): ?>
                <ul class="error_list"><li>&nbsp;</li></ul>
              <?php endif ?>
          ...
          <tr>
            <td class="anchoColumna tituloCampo tdperfil">
              <?php if ($profileEditForm['passwordNew']->hasError()): ?>
                <ul class="error_list"><li>&nbsp;</li></ul>
              <?php endif ?>
          ...
          <tr>
            <td class="anchoColumna tituloCampo tdperfil">
              <?php if ($profileEditForm['passwordBis']->hasError()): ?>
                <ul class="error_list"><li>&nbsp;</li></ul>
              <?php endif ?>
          ...
          <tr>
            <td class="anchoColumna tituloCampo tdperfil">
              <?php if ($profileEditForm['passwordOld']->hasError()): ?>
                <ul class="error_list"><li>&nbsp;</li></ul>
              <?php endif ?>
