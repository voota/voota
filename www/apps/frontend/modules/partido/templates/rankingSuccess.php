  ...
  <thead>
    <tr>
      ...
      <th class="positive-votes">
      	<?php echo link_to(__('Votos +'), "partido/ranking".($order=='pd'?"?o=pa":''), array('rel'  => 'nofollow'));?>
      ...
      <th class="negative-votes">
      	<?php echo link_to(__('Votos -'), "partido/ranking?o=".($order=='nd'?'na':'nd'), array('rel'  => 'nofollow'));?>
