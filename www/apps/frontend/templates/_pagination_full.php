<?php if ($pager->haveToPaginate()): ?>
 ...
 <?php echo link_to('&laquo;Anterior', $url ."$page_var=".$pager->getPreviousPage() . (isset($order)?"&o=$order":''), array('class'  => 'numerosPag')) ?>
  ...
  <?php endforeach ?>
    ...
    <?php endif ?>
  <?php echo link_to('Siguiente&raquo;', $url . "$page_var=".$pager->getNextPage() . (isset($order)?"&o=$order":''), array('class'  => 'numerosPag')) ?>
