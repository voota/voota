<?php if ($pager->haveToPaginate()): ?>
 ...
 <?php echo link_to('&lt;&lt;Anterior', $url ."$page_var=".$pager->getPreviousPage() . ($order?"&o=$order":''), array('class'  => 'numerosPag')) ?>
  ...
  <?php echo link_to('Siguiente&gt;&gt;', $url . "$page_var=".$pager->getNextPage() . ($order?"&o=$order":''), array('class'  => 'numerosPag')) ?>
