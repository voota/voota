...
abstract class BasePropuestaPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Titulo', 'Descripcion', 'Culture', 'Imagen', 'Doc', 'SfGuardUserId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'titulo', 'descripcion', 'culture', 'imagen', 'doc', 'sfGuardUserId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TITULO, self::DESCRIPCION, self::CULTURE, self::IMAGEN, self::DOC, self::SF_GUARD_USER_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'titulo', 'descripcion', 'culture', 'imagen', 'doc', 'sf_guard_user_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Titulo' => 1, 'Descripcion' => 2, 'Culture' => 3, 'Imagen' => 4, 'Doc' => 5, 'SfGuardUserId' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'titulo' => 1, 'descripcion' => 2, 'culture' => 3, 'imagen' => 4, 'doc' => 5, 'sfGuardUserId' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TITULO => 1, self::DESCRIPCION => 2, self::CULTURE => 3, self::IMAGEN => 4, self::DOC => 5, self::SF_GUARD_USER_ID => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'titulo' => 1, 'descripcion' => 2, 'culture' => 3, 'imagen' => 4, 'doc' => 5, 'sf_guard_user_id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
