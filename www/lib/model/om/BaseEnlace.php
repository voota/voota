...
abstract class BaseEnlace extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->mostrar = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			...
			return $startcol + 11; // 11 = EnlacePeer::NUM_COLUMNS - EnlacePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[8], $arr)) $this->setMostrar($arr[$keys[8]]);
