...
abstract class BaseEnlace extends BaseObject  implements Persistent {
	...
	public function setPropuestaId($v)
	{
		...
		if ($this->propuesta_id !== $v) {
			$this->propuesta_id = $v;
			$this->modifiedColumns[] = EnlacePeer::PROPUESTA_ID;
		}
	...
	public function setEleccionId($v)
	{
		...
		if ($this->eleccion_id !== $v) {
			$this->eleccion_id = $v;
			$this->modifiedColumns[] = EnlacePeer::ELECCION_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->propuesta_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->eleccion_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->sf_guard_user_id = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
			$this->orden = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
			$this->mostrar = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			...
			return $startcol + 12; // 12 = EnlacePeer::NUM_COLUMNS - EnlacePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[5] => $this->getPropuestaId(),
			$keys[6] => $this->getEleccionId(),
			$keys[7] => $this->getSfGuardUserId(),
			$keys[8] => $this->getOrden(),
			$keys[9] => $this->getMostrar(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setPropuestaId($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setEleccionId($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setSfGuardUserId($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setOrden($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setMostrar($arr[$keys[9]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EnlacePeer::PROPUESTA_ID)) $criteria->add(EnlacePeer::PROPUESTA_ID, $this->propuesta_id);
		if ($this->isColumnModified(EnlacePeer::ELECCION_ID)) $criteria->add(EnlacePeer::ELECCION_ID, $this->eleccion_id);
	...
	public function getPropuesta(PropelPDO $con = null)
	{
		if ($this->aPropuesta === null && ($this->propuesta_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aPropuesta->addEnlaces($this);
			 */
		}
	...
	public function getEleccion(PropelPDO $con = null)
	{
		if ($this->aEleccion === null && ($this->eleccion_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aEleccion->addEnlaces($this);
			 */
		}
