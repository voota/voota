...
abstract class BaseEnlace extends BaseObject  implements Persistent {
  ...
  const PEER = 'EnlacePeer';
	...
	/**
	 * Initializes internal state of BaseEnlace object.
	 * @see        applyDefaults()
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->mostrar = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			...
			return $startcol + 8; // 8 = EnlacePeer::NUM_COLUMNS - EnlacePeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    if ($this->isNew() && !$this->isColumnModified(EnlacePeer::CREATED_AT))
    {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setMostrar($arr[$keys[6]]);
