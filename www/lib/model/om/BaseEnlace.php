...
abstract class BaseEnlace extends BaseObject  implements Persistent {
	...
	public function setConvocatoriaId($v)
	{
		...
		if ($this->convocatoria_id !== $v) {
			...
			$this->modifiedColumns[] = EnlacePeer::CONVOCATORIA_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->convocatoria_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setConvocatoriaId($arr[$keys[6]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EnlacePeer::CONVOCATORIA_ID)) $criteria->add(EnlacePeer::CONVOCATORIA_ID, $this->convocatoria_id);
	...
	public function getConvocatoria(PropelPDO $con = null)
	{
		if ($this->aConvocatoria === null && ($this->convocatoria_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aConvocatoria->addEnlaces($this);
			 */
		}
