  ...
  const PEER = 'SfGuardUserProfilePeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->acepta_mensajes = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->nombre = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->apellidos = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setAceptaMensajes($arr[$keys[4]]);
	 ...
	 * related Opinions from storage. If this SfGuardUserProfile is new, it will return
		...
		if ($this->collOpinions === null) {
			if ($this->isNew()) {
			   $this->collOpinions = array();
				...
				$criteria->add(OpinionPeer::SF_GUARD_USER_PROFILE_ID, $this->id);
