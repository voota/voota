...
/**
 * Base class that represents a row from the 'etiqueta_partido' table.
 *
 * 
 *
 ...
 */
abstract class BaseEtiquetaPartido extends BaseObject  implements Persistent {
	...
	const PEER = 'EtiquetaPartidoPeer';
	...
	public function setEtiquetaId($v)
	{
		...
		if ($this->etiqueta_id !== $v) {
			$this->etiqueta_id = $v;
			$this->modifiedColumns[] = EtiquetaPartidoPeer::ETIQUETA_ID;
		}
	...
	public function setPartidoId($v)
	{
		...
		if ($this->partido_id !== $v) {
			$this->partido_id = $v;
			$this->modifiedColumns[] = EtiquetaPartidoPeer::PARTIDO_ID;
		}
	...
	public function setCulture($v)
	{
		...
		if ($this->culture !== $v) {
			$this->culture = $v;
			$this->modifiedColumns[] = EtiquetaPartidoPeer::CULTURE;
		}
	...
	public function setFecha($v)
	{
		...
		if ( $this->fecha !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = EtiquetaPartidoPeer::FECHA;
			}
	...
	public function setSfGuardUserId($v)
	{
		...
		if ($this->sf_guard_user_id !== $v) {
			...
			$this->modifiedColumns[] = EtiquetaPartidoPeer::SF_GUARD_USER_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = EtiquetaPartidoPeer::NUM_COLUMNS - EtiquetaPartidoPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating EtiquetaPartido object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = EtiquetaPartidoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseEtiquetaPartido:delete:pre') as $callable)
			{
			...
			if ($ret) {
				EtiquetaPartidoPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseEtiquetaPartido:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseEtiquetaPartido:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseEtiquetaPartido:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				EtiquetaPartidoPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = EtiquetaPartidoPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = EtiquetaPartidoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = EtiquetaPartidoPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EtiquetaPartidoPeer::ETIQUETA_ID)) $criteria->add(EtiquetaPartidoPeer::ETIQUETA_ID, $this->etiqueta_id);
		if ($this->isColumnModified(EtiquetaPartidoPeer::PARTIDO_ID)) $criteria->add(EtiquetaPartidoPeer::PARTIDO_ID, $this->partido_id);
		if ($this->isColumnModified(EtiquetaPartidoPeer::CULTURE)) $criteria->add(EtiquetaPartidoPeer::CULTURE, $this->culture);
		if ($this->isColumnModified(EtiquetaPartidoPeer::FECHA)) $criteria->add(EtiquetaPartidoPeer::FECHA, $this->fecha);
		if ($this->isColumnModified(EtiquetaPartidoPeer::SF_GUARD_USER_ID)) $criteria->add(EtiquetaPartidoPeer::SF_GUARD_USER_ID, $this->sf_guard_user_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(EtiquetaPartidoPeer::ETIQUETA_ID, $this->etiqueta_id);
		$criteria->add(EtiquetaPartidoPeer::PARTIDO_ID, $this->partido_id);
		$criteria->add(EtiquetaPartidoPeer::CULTURE, $this->culture);
		$criteria->add(EtiquetaPartidoPeer::SF_GUARD_USER_ID, $this->sf_guard_user_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of EtiquetaPartido (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     EtiquetaPartido Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     EtiquetaPartidoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new EtiquetaPartidoPeer();
		}
		return self::$peer;
	}
	...
	public function getEtiqueta(PropelPDO $con = null)
	{
		if ($this->aEtiqueta === null && ($this->etiqueta_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aEtiqueta->addEtiquetaPartidos($this);
			 */
		}
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->sf_guard_user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUser->addEtiquetaPartidos($this);
			 */
		}
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseEtiquetaPartido:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseEtiquetaPartido::%s', $method));
	  }
