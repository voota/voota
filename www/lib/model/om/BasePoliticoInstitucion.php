...
abstract class BasePoliticoInstitucion extends BaseObject  implements Persistent {
	...
	public function setCargo($v)
	{
		...
		if ($this->cargo !== $v) {
			$this->cargo = $v;
			$this->modifiedColumns[] = PoliticoInstitucionPeer::CARGO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = PoliticoInstitucionPeer::NUM_COLUMNS - PoliticoInstitucionPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PoliticoInstitucionPeer::CARGO)) $criteria->add(PoliticoInstitucionPeer::CARGO, $this->cargo);
