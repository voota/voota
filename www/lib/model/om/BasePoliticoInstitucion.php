...
/**
 * Base class that represents a row from the 'politico_institucion' table.
 *
 * 
 *
 ...
 */
abstract class BasePoliticoInstitucion extends BaseObject  implements Persistent {


  const PEER = 'PoliticoInstitucionPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        PoliticoInstitucionPeer
	 */
	...
	/**
	 * Initializes internal state of BasePoliticoInstitucion object.
	 * @see        applyDefaults()
	 */
	...
	public function setPoliticoId($v)
	{
		...
		if ($this->politico_id !== $v) {
			$this->politico_id = $v;
			$this->modifiedColumns[] = PoliticoInstitucionPeer::POLITICO_ID;
		}
	...
	public function setInstitucionId($v)
	{
		...
		if ($this->institucion_id !== $v) {
			...
			$this->modifiedColumns[] = PoliticoInstitucionPeer::INSTITUCION_ID;
		}
	...
	public function setFechaInicio($v)
	{
		...
		if ( $this->fecha_inicio !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PoliticoInstitucionPeer::FECHA_INICIO;
			}
	...
	public function setFechaFin($v)
	{
		...
		if ( $this->fecha_fin !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PoliticoInstitucionPeer::FECHA_FIN;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = PoliticoInstitucionPeer::NUM_COLUMNS - PoliticoInstitucionPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating PoliticoInstitucion object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PoliticoInstitucionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BasePoliticoInstitucion:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			PoliticoInstitucionPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BasePoliticoInstitucion:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BasePoliticoInstitucion:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BasePoliticoInstitucion:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			PoliticoInstitucionPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PoliticoInstitucionPeer::doInsert($this, $con);
					...
					$affectedRows += PoliticoInstitucionPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PoliticoInstitucionPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PoliticoInstitucionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = PoliticoInstitucionPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PoliticoInstitucionPeer::POLITICO_ID)) $criteria->add(PoliticoInstitucionPeer::POLITICO_ID, $this->politico_id);
		if ($this->isColumnModified(PoliticoInstitucionPeer::INSTITUCION_ID)) $criteria->add(PoliticoInstitucionPeer::INSTITUCION_ID, $this->institucion_id);
		if ($this->isColumnModified(PoliticoInstitucionPeer::FECHA_INICIO)) $criteria->add(PoliticoInstitucionPeer::FECHA_INICIO, $this->fecha_inicio);
		if ($this->isColumnModified(PoliticoInstitucionPeer::FECHA_FIN)) $criteria->add(PoliticoInstitucionPeer::FECHA_FIN, $this->fecha_fin);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PoliticoInstitucionPeer::POLITICO_ID, $this->politico_id);
		$criteria->add(PoliticoInstitucionPeer::INSTITUCION_ID, $this->institucion_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PoliticoInstitucion (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PoliticoInstitucion Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PoliticoInstitucionPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PoliticoInstitucionPeer();
		}
		return self::$peer;
	}
	...
	public function getPolitico(PropelPDO $con = null)
	{
		if ($this->aPolitico === null && ($this->politico_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aPolitico->addPoliticoInstitucions($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BasePoliticoInstitucion:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BasePoliticoInstitucion::%s', $method));
    }
