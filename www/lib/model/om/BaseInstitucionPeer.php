...
abstract class BaseInstitucionPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'GeoId', 'CreatedAt', 'Disabled', 'Orden', 'Url', 'Imagen', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'geoId', 'createdAt', 'disabled', 'orden', 'url', 'imagen', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::GEO_ID, self::CREATED_AT, self::DISABLED, self::ORDEN, self::URL, self::IMAGEN, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'geo_id', 'created_at', 'disabled', 'orden', 'url', 'imagen', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'GeoId' => 1, 'CreatedAt' => 2, 'Disabled' => 3, 'Orden' => 4, 'Url' => 5, 'Imagen' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'geoId' => 1, 'createdAt' => 2, 'disabled' => 3, 'orden' => 4, 'url' => 5, 'imagen' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::GEO_ID => 1, self::CREATED_AT => 2, self::DISABLED => 3, self::ORDEN => 4, self::URL => 5, self::IMAGEN => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'geo_id' => 1, 'created_at' => 2, 'disabled' => 3, 'orden' => 4, 'url' => 5, 'imagen' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
  ...
  /**
   * Selects a collection of Institucion objects pre-filled with their i18n objects.
   *
   * @return array Array of Institucion objects.
   * @throws PropelException Any exceptions caught during processing will be
   *     rethrown wrapped into a PropelException.
  ...
  public static function doSelectWithI18n(Criteria $c, $culture = null, PropelPDO $con = null)
  {
    ...
    $c->add(InstitucionI18nPeer::CULTURE, $culture);
