...
/**
 * Base class that represents a row from the 'etiqueta_politico' table.
 *
 * 
 *
 ...
 */
abstract class BaseEtiquetaPolitico extends BaseObject  implements Persistent {
	...
	const PEER = 'EtiquetaPoliticoPeer';
	 ...
	 * @return     EtiquetaPolitico The current object (for fluent API support)
	 */
	public function setEtiquetaId($v)
	{
		...
		if ($this->etiqueta_id !== $v) {
			$this->etiqueta_id = $v;
			$this->modifiedColumns[] = EtiquetaPoliticoPeer::ETIQUETA_ID;
		}
	...
	public function setPoliticoId($v)
	{
		...
		if ($this->politico_id !== $v) {
			$this->politico_id = $v;
			$this->modifiedColumns[] = EtiquetaPoliticoPeer::POLITICO_ID;
		}
	...
	public function setCulture($v)
	{
		...
		if ($this->culture !== $v) {
			$this->culture = $v;
			$this->modifiedColumns[] = EtiquetaPoliticoPeer::CULTURE;
		}
	...
	public function setFecha($v)
	{
		...
		if ( $this->fecha !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = EtiquetaPoliticoPeer::FECHA;
			}
	...
	public function setSfGuardUserId($v)
	{
		...
		if ($this->sf_guard_user_id !== $v) {
			...
			$this->modifiedColumns[] = EtiquetaPoliticoPeer::SF_GUARD_USER_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->politico_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->culture = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->fecha = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->sf_guard_user_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = EtiquetaPoliticoPeer::NUM_COLUMNS - EtiquetaPoliticoPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating EtiquetaPolitico object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = EtiquetaPoliticoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseEtiquetaPolitico:delete:pre') as $callable)
			{
			...
			if ($ret) {
				EtiquetaPoliticoPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseEtiquetaPolitico:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseEtiquetaPolitico:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseEtiquetaPolitico:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				EtiquetaPoliticoPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = EtiquetaPoliticoPeer::doInsert($this, $con);
					...
					$affectedRows += EtiquetaPoliticoPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = EtiquetaPoliticoPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = EtiquetaPoliticoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = EtiquetaPoliticoPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EtiquetaPoliticoPeer::ETIQUETA_ID)) $criteria->add(EtiquetaPoliticoPeer::ETIQUETA_ID, $this->etiqueta_id);
		if ($this->isColumnModified(EtiquetaPoliticoPeer::POLITICO_ID)) $criteria->add(EtiquetaPoliticoPeer::POLITICO_ID, $this->politico_id);
		if ($this->isColumnModified(EtiquetaPoliticoPeer::CULTURE)) $criteria->add(EtiquetaPoliticoPeer::CULTURE, $this->culture);
		if ($this->isColumnModified(EtiquetaPoliticoPeer::FECHA)) $criteria->add(EtiquetaPoliticoPeer::FECHA, $this->fecha);
		if ($this->isColumnModified(EtiquetaPoliticoPeer::SF_GUARD_USER_ID)) $criteria->add(EtiquetaPoliticoPeer::SF_GUARD_USER_ID, $this->sf_guard_user_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(EtiquetaPoliticoPeer::ETIQUETA_ID, $this->etiqueta_id);
		$criteria->add(EtiquetaPoliticoPeer::POLITICO_ID, $this->politico_id);
		$criteria->add(EtiquetaPoliticoPeer::CULTURE, $this->culture);
		$criteria->add(EtiquetaPoliticoPeer::SF_GUARD_USER_ID, $this->sf_guard_user_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of EtiquetaPolitico (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     EtiquetaPolitico Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     EtiquetaPoliticoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new EtiquetaPoliticoPeer();
		}
		return self::$peer;
	}
	...
	public function getEtiqueta(PropelPDO $con = null)
	{
		if ($this->aEtiqueta === null && ($this->etiqueta_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aEtiqueta->addEtiquetaPoliticos($this);
			 */
		}
	...
	public function getPolitico(PropelPDO $con = null)
	{
		if ($this->aPolitico === null && ($this->politico_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aPolitico->addEtiquetaPoliticos($this);
			 */
		}
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->sf_guard_user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUser->addEtiquetaPoliticos($this);
			 */
		}
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseEtiquetaPolitico:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseEtiquetaPolitico::%s', $method));
	  }
