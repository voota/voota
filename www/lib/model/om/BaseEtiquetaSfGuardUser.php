...
/**
 * Base class that represents a row from the 'etiqueta_sf_guard_user' table.
 *
 * 
 *
 ...
 */
abstract class BaseEtiquetaSfGuardUser extends BaseObject  implements Persistent {
	...
	const PEER = 'EtiquetaSfGuardUserPeer';
	 ...
	 * @return     EtiquetaSfGuardUser The current object (for fluent API support)
	 */
	public function setEtiquetaId($v)
	{
		...
		if ($this->etiqueta_id !== $v) {
			$this->etiqueta_id = $v;
			$this->modifiedColumns[] = EtiquetaSfGuardUserPeer::ETIQUETA_ID;
		}
	...
	public function setSfGuardUserId($v)
	{
		...
		if ($this->sf_guard_user_id !== $v) {
			...
			$this->modifiedColumns[] = EtiquetaSfGuardUserPeer::SF_GUARD_USER_ID;
		}
	...
	public function setFecha($v)
	{
		...
		if ( $this->fecha !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = EtiquetaSfGuardUserPeer::FECHA;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = EtiquetaSfGuardUserPeer::NUM_COLUMNS - EtiquetaSfGuardUserPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating EtiquetaSfGuardUser object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = EtiquetaSfGuardUserPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseEtiquetaSfGuardUser:delete:pre') as $callable)
			{
			...
			if ($ret) {
				EtiquetaSfGuardUserPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseEtiquetaSfGuardUser:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseEtiquetaSfGuardUser:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseEtiquetaSfGuardUser:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				EtiquetaSfGuardUserPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = EtiquetaSfGuardUserPeer::doInsert($this, $con);
					...
					$affectedRows += EtiquetaSfGuardUserPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = EtiquetaSfGuardUserPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = EtiquetaSfGuardUserPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = EtiquetaSfGuardUserPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EtiquetaSfGuardUserPeer::ETIQUETA_ID)) $criteria->add(EtiquetaSfGuardUserPeer::ETIQUETA_ID, $this->etiqueta_id);
		if ($this->isColumnModified(EtiquetaSfGuardUserPeer::SF_GUARD_USER_ID)) $criteria->add(EtiquetaSfGuardUserPeer::SF_GUARD_USER_ID, $this->sf_guard_user_id);
		if ($this->isColumnModified(EtiquetaSfGuardUserPeer::FECHA)) $criteria->add(EtiquetaSfGuardUserPeer::FECHA, $this->fecha);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(EtiquetaSfGuardUserPeer::ETIQUETA_ID, $this->etiqueta_id);
		$criteria->add(EtiquetaSfGuardUserPeer::SF_GUARD_USER_ID, $this->sf_guard_user_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of EtiquetaSfGuardUser (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     EtiquetaSfGuardUser Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     EtiquetaSfGuardUserPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new EtiquetaSfGuardUserPeer();
		}
		return self::$peer;
	}
	...
	public function getEtiqueta(PropelPDO $con = null)
	{
		if ($this->aEtiqueta === null && ($this->etiqueta_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aEtiqueta->addEtiquetaSfGuardUsers($this);
			 */
		}
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->sf_guard_user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUser->addEtiquetaSfGuardUsers($this);
			 */
		}
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseEtiquetaSfGuardUser:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseEtiquetaSfGuardUser::%s', $method));
	  }
