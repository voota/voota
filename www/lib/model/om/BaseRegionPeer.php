...
abstract class BaseRegionPeer {
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method to DELETE all rows from the region table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
...
//
// NOTE: This static code cannot call methods on the RegionPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the RegionPeer class:
//
// Propel::getDatabaseMap(RegionPeer::DATABASE_NAME)->addTableBuilder(RegionPeer::TABLE_NAME, RegionPeer::getMapBuilder());
//
