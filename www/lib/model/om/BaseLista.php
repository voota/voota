...
abstract class BaseLista extends BaseObject  implements Persistent {
	...
	public function setCircunscripcionId($v)
	{
		...
		if ($this->circunscripcion_id !== $v) {
			...
			$this->modifiedColumns[] = ListaPeer::CIRCUNSCRIPCION_ID;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ListaPeer::CIRCUNSCRIPCION_ID)) $criteria->add(ListaPeer::CIRCUNSCRIPCION_ID, $this->circunscripcion_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ListaPeer::CIRCUNSCRIPCION_ID, $this->circunscripcion_id);
	...
	public function getPrimaryKey()
	{
		...
		$pks[1] = $this->getCircunscripcionId();
	...
	public function setPrimaryKey($keys)
	{
		...
		$this->setCircunscripcionId($keys[1]);
	...
	public function getCircunscripcion(PropelPDO $con = null)
	{
		if ($this->aCircunscripcion === null && ($this->circunscripcion_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aCircunscripcion->addListas($this);
			 */
		}
