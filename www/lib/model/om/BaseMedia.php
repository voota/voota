...
abstract class BaseMedia extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the idmedia field.
	 * @var        int
	 */
	protected $idmedia;
	...
	/**
	 * The value for the idpolitico field.
	 * @var        int
	 */
	protected $idpolitico;
	...
	/**
	 * Get the [idpolitico] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Set the value of [idmedia] column.
	 * 
	 * @param      int $v new value
	 * @return     Media The current object (for fluent API support)
	 */
	public function setIdmedia($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->idmedia !== $v) {
			$this->idmedia = $v;
			$this->modifiedColumns[] = MediaPeer::IDMEDIA;
		}
	...
	public function setTipo($v)
	{
		...
		if ($this->tipo !== $v) {
			$this->tipo = $v;
			$this->modifiedColumns[] = MediaPeer::TIPO;
		}
	...
	/**
	 * Set the value of [idpolitico] column.
	 * 
	 * @param      int $v new value
	 * @return     Media The current object (for fluent API support)
	 */
	public function setIdpolitico($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->idpolitico !== $v) {
			$this->idpolitico = $v;
			$this->modifiedColumns[] = MediaPeer::IDPOLITICO;
		}
	...
	public function setIdpartido($v)
	{
		...
		if ($this->idpartido !== $v) {
			$this->idpartido = $v;
			$this->modifiedColumns[] = MediaPeer::IDPARTIDO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->idmedia = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->tipo = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->idpolitico = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->idpartido = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = MediaPeer::NUM_COLUMNS - MediaPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			$keys[0] => $this->getIdmedia(),
			$keys[1] => $this->getTipo(),
			$keys[2] => $this->getIdpolitico(),
			$keys[3] => $this->getIdpartido(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			case 0:
				$this->setIdmedia($value);
				break;
			case 1:
				$this->setTipo($value);
				break;
			case 2:
				$this->setIdpolitico($value);
				break;
			case 3:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setIdmedia($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setTipo($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setIdpolitico($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setIdpartido($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MediaPeer::IDMEDIA)) $criteria->add(MediaPeer::IDMEDIA, $this->idmedia);
		if ($this->isColumnModified(MediaPeer::TIPO)) $criteria->add(MediaPeer::TIPO, $this->tipo);
		if ($this->isColumnModified(MediaPeer::IDPOLITICO)) $criteria->add(MediaPeer::IDPOLITICO, $this->idpolitico);
		if ($this->isColumnModified(MediaPeer::IDPARTIDO)) $criteria->add(MediaPeer::IDPARTIDO, $this->idpartido);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(MediaPeer::IDMEDIA, $this->idmedia);
	...
	/**
	 * Generic method to set the primary key (idmedia column).
	 *
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdmedia($this->idmedia);

		$copyObj->setTipo($this->tipo);

		$copyObj->setIdpolitico($this->idpolitico);

		$copyObj->setIdpartido($this->idpartido);
