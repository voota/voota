...
/**
 * Base class that represents a row from the 'politico_lista' table.
 *
 * 
 *
 ...
 */
abstract class BasePoliticoLista extends BaseObject  implements Persistent {


  const PEER = 'PoliticoListaPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        PoliticoListaPeer
	 */
	...
	/**
	 * Initializes internal state of BasePoliticoLista object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     PoliticoLista The current object (for fluent API support)
	 */
	public function setPoliticoId($v)
	{
		...
		if ($this->politico_id !== $v) {
			$this->politico_id = $v;
			$this->modifiedColumns[] = PoliticoListaPeer::POLITICO_ID;
		}
	...
	public function setListaId($v)
	{
		...
		if ($this->lista_id !== $v) {
			$this->lista_id = $v;
			$this->modifiedColumns[] = PoliticoListaPeer::LISTA_ID;
		}
	...
	public function setOrden($v)
	{
		...
		if ($this->orden !== $v) {
			$this->orden = $v;
			$this->modifiedColumns[] = PoliticoListaPeer::ORDEN;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PoliticoListaPeer::CREATED_AT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->orden = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			return $startcol + 4; // 4 = PoliticoListaPeer::NUM_COLUMNS - PoliticoListaPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating PoliticoLista object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PoliticoListaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BasePoliticoLista:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			PoliticoListaPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BasePoliticoLista:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BasePoliticoLista:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(PoliticoListaPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BasePoliticoLista:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			PoliticoListaPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PoliticoListaPeer::doInsert($this, $con);
					...
					$affectedRows += PoliticoListaPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PoliticoListaPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PoliticoListaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PoliticoListaPeer::POLITICO_ID)) $criteria->add(PoliticoListaPeer::POLITICO_ID, $this->politico_id);
		if ($this->isColumnModified(PoliticoListaPeer::LISTA_ID)) $criteria->add(PoliticoListaPeer::LISTA_ID, $this->lista_id);
		if ($this->isColumnModified(PoliticoListaPeer::ORDEN)) $criteria->add(PoliticoListaPeer::ORDEN, $this->orden);
		if ($this->isColumnModified(PoliticoListaPeer::CREATED_AT)) $criteria->add(PoliticoListaPeer::CREATED_AT, $this->created_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PoliticoListaPeer::POLITICO_ID, $this->politico_id);
		$criteria->add(PoliticoListaPeer::LISTA_ID, $this->lista_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PoliticoLista (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PoliticoLista Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PoliticoListaPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PoliticoListaPeer();
		}
		return self::$peer;
	}
	...
	public function getPolitico(PropelPDO $con = null)
	{
		if ($this->aPolitico === null && ($this->politico_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aPolitico->addPoliticoListas($this);
			 */
		}
	...
	public function getLista(PropelPDO $con = null)
	{
		if ($this->aLista === null && ($this->lista_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aLista->addPoliticoListas($this);
			 */
		}
		return $this->aLista;
	}
  ...
  {
    if (!$callable = sfMixer::getCallable('BasePoliticoLista:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BasePoliticoLista::%s', $method));
    }
