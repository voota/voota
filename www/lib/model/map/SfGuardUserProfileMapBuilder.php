...
class SfGuardUserProfileMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('MAILS_COMENTARIOS', 'MailsComentarios', 'INTEGER', true, 11);

		$tMap->addColumn('MAILS_NOTICIAS', 'MailsNoticias', 'INTEGER', true, 11);

		$tMap->addColumn('MAILS_CONTACTO', 'MailsContacto', 'INTEGER', true, 11);

		$tMap->addColumn('MAILS_SEGUIDOR', 'MailsSeguidor', 'INTEGER', true, 11);
