...
/**
 * This class defines the structure of the 'politico_lista' table.
 *
 *
 ...
 */
class PoliticoListaTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.PoliticoListaTableMap';
	...
	{
	  // attributes
		$this->setName('politico_lista');
		$this->setPhpName('PoliticoLista');
		$this->setClassname('PoliticoLista');
		...
		$this->addColumn('ORDEN', 'Orden', 'INTEGER', true, 11, null);
