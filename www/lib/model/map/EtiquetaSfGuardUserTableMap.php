...
/**
 * This class defines the structure of the 'etiqueta_sf_guard_user' table.
 *
 *
 ...
 */
class EtiquetaSfGuardUserTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.EtiquetaSfGuardUserTableMap';
	...
	{
	  // attributes
		$this->setName('etiqueta_sf_guard_user');
		$this->setPhpName('EtiquetaSfGuardUser');
		$this->setClassname('EtiquetaSfGuardUser');
