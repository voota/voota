...
/**
 * This class defines the structure of the 'etiqueta_politico' table.
 *
 *
 ...
 */
class EtiquetaPoliticoTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.EtiquetaPoliticoTableMap';
	...
	{
	  // attributes
		$this->setName('etiqueta_politico');
		$this->setPhpName('EtiquetaPolitico');
		$this->setClassname('EtiquetaPolitico');
