...
class EnlaceTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('PROPUESTA_ID', 'PropuestaId', 'INTEGER', 'propuesta', 'ID', false, 11, null);
		$this->addForeignKey('CONVOCATORIA_ID', 'ConvocatoriaId', 'INTEGER', 'convocatoria', 'ID', false, 11, null);
