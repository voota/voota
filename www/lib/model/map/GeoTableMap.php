...
class GeoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('CODIGO', 'Codigo', 'INTEGER', false, 11, null);
    ...
    $this->addRelation('Circunscripcion', 'Circunscripcion', RelationMap::ONE_TO_MANY, array('id' => 'geo_id', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
