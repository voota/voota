...
class SfGuardUserProfileTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('TW_PUBLISH_VOTOS', 'TwPublishVotos', 'BOOLEAN', true, null, true);
		$this->addColumn('TW_PUBLISH_VOTOS_OTROS', 'TwPublishVotosOtros', 'BOOLEAN', true, null, true);
		$this->addColumn('TW_PUBLISH_CAMBIOS_PERFIL', 'TwPublishCambiosPerfil', 'BOOLEAN', true, null, true);
		$this->addColumn('TW_OAUTH_TOKEN', 'TwOauthToken', 'VARCHAR', false, 45, null);
		$this->addColumn('TW_OAUTH_TOKEN_SECRET', 'TwOauthTokenSecret', 'VARCHAR', false, 45, null);
		$this->addColumn('ANONYMOUS', 'Anonymous', 'BOOLEAN', true, null, false);
		// validators
	} // initialize()
    ...
    $this->addRelation('SfGuardUserProfileI18n', 'SfGuardUserProfileI18n', RelationMap::ONE_TO_MANY, array('id' => 'id', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
	...
	public function getBehaviors()
	{
		return array(
			...
			'symfony_i18n' => array('i18n_table' => 'sf_guard_user_profile_i18n', ),
		);
	} // getBehaviors()
