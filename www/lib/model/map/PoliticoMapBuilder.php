...
class PoliticoMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addForeignKey('USUARIO_ID', 'UsuarioId', 'INTEGER', 'usuario', 'ID', false, 11);

		$tMap->addColumn('CREATED_AT', 'CreatedAt', 'TIMESTAMP', false, null);

		$tMap->addColumn('PARTIDO_ID', 'PartidoId', 'INTEGER', false, 11);

		$tMap->addColumn('BIO', 'Bio', 'VARCHAR', false, 255);
