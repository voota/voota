...
class PoliticoTableMap extends TableMap {
    ...
    $this->addRelation('EtiquetaPolitico', 'EtiquetaPolitico', RelationMap::ONE_TO_MANY, array('id' => 'politico_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('ListaCalle', 'ListaCalle', RelationMap::ONE_TO_MANY, array('id' => 'politico_id', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
