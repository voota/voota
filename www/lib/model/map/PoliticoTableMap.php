...
class PoliticoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('URL_KEY', 'UrlKey', 'VARCHAR', true, 45, null);
		...
		$this->addForeignKey('SF_GUARD_USER_PROFILE_ID', 'SfGuardUserProfileId', 'INTEGER', 'sf_guard_user_profile', 'ID', false, 11, null);
	...
	{
    $this->addRelation('SfGuardUserProfile', 'SfGuardUserProfile', RelationMap::MANY_TO_ONE, array('sf_guard_user_profile_id' => 'id', ), 'RESTRICT', 'RESTRICT');
