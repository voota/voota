 ...
 */
class sfQueryPager extends sfPager
{
  protected
    $criteria               = null,
  ...
  protected function getCounter(){
		...
		$statement = $connection->prepare("SELECT count(*) as count FROM (".$this->query.") t");
  ...
  public function getResults()
  {
	   	$connection = Propel::getConnection();
	   	$aQuery = $this->query;
	   	$aQuery .= " LIMIT ". ($this->offset?$this->offset.', ':'') . $this->limit;
		$statement = $connection->prepare($aQuery);
		//echo $aQuery; die;
		...
		return $statement->fetchAll(PDO::FETCH_CLASS, $this->tableName);
  }
