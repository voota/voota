...
abstract class BaseEtiquetaFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'etiqueta_sf_guard_user_list' => new sfWidgetFormPropelChoice(array('model' => 'sfGuardUser', 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'etiqueta_sf_guard_user_list' => new sfValidatorPropelChoice(array('model' => 'sfGuardUser', 'required' => false)),
  ...
  public function addEtiquetaSfGuardUserListColumnCriteria(Criteria $criteria, $field, $values)
  {
    ...
    $criteria->addJoin(EtiquetaSfGuardUserPeer::ETIQUETA_ID, EtiquetaPeer::ID);

    $value = array_pop($values);
    $criterion = $criteria->getNewCriterion(EtiquetaSfGuardUserPeer::SF_GUARD_USER_ID, $value);

    foreach ($values as $value)
    {
      $criterion->addOr($criteria->getNewCriterion(EtiquetaSfGuardUserPeer::SF_GUARD_USER_ID, $value));
    }
